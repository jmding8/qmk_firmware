...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [APL] = LAYOUT(
      ...
      KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,               KC_N,          KC_M,   KC_COMM,  KC_DOT,  KC_SLSH, KC_RSFT,
                                 KC_LCTL, KC_LALT, KC_LGUI,    LT(NAV, KC_SPC), LT(NUM, KC_0), MO(ADJUST)
    ),
    [WIN] = LAYOUT(
       KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,               KC_Y,          KC_U,      KC_I,    KC_O,     KC_P, KC_BSPC,
       KC_ESC,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,               KC_H,          KC_J,      KC_K,    KC_L,  KC_SCLN, KC_QUOT,
    ...
    [NUM] = LAYOUT(
      ...
      _______,   KC_F5,   KC_F6,   KC_F7,   KC_F8, _______,    _______,    KC_4,    KC_5,    KC_6, KC_LBRC, KC_RBRC,
      _______,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______,    _______,    KC_1,    KC_2,    KC_3,    KC_0,  KC_GRV,
                                 _______, _______, _______,    _______, _______, _______
    ),
    [ADJUST] = LAYOUT(
